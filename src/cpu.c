...
const struct cpu_instruction cpu_instructions[256] = {
    ...
    { "LD A, H", 0, 2, ld_a_h },
    { "LD A, L", 0, 2, ld_a_l },
    { "LD A, (HL)", 0, 4, ld_a_hlp },
    { "LD A, A", 0, 2, nop },
    { "ADD A, B", 0, 2, add_a_b },               // 0x80
    { "ADD A, C", 0, 2, add_a_c },
    { "ADD A, D", 0, 2, add_a_d },
    { "ADD A, E", 0, 2, add_a_e },
    { "ADD A, H", 0, 2, add_a_h },
    ...
    { "POP AF", 0, 6, pop_af },
    { "LD A, (C)", 0, 4, ld_a_ff_c },
    { "DI", 0, 0, di_inst },
    { "NULL (0xF4)", 0, 0, cpu_unimplemented_instruction },
    { "PUSH AF", 0, 8, push_af },
    { "OR d8", 1, 4, or_n },
    { "RST 6", 0, 8, rst_6 },
    { "LD HL, SP+s8", 1, 6, ld_hl_sp_n },
    { "LD SP, HL", 0, 4, ld_sp_hl },
    { "LD A, (a16)", 2, 8, ld_a_nnp },
    { "EI", 0, 2, ei },
